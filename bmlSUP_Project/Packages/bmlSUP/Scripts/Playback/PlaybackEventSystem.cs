...
namespace Playback {
    public class PlaybackEventSystem : MonoBehaviour {
        ...
        public delegate void PlayingNewAnimationSetEvent(List<AMASSAnimation> animations);

        public static event PlayingNewAnimationSetEvent OnPlayingNewAnimationSet;

        public static void PlayingNewAnimationSet(List<AMASSAnimation> animations) {
